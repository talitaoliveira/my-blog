...
Então, para demonstrar isso, criei um projeto básico. Usei o <a href="https://create-react-app.dev/docs/getting-started" target="_blank">create-react-app</a> para iniciar o projeto. 
